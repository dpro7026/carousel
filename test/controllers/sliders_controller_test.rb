...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { content: @slider.content, title: @slider.title } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { content: @slider.content, title: @slider.title } }
